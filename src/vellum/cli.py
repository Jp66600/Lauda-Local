...
def _load_dotenv() -> None:
    ...
    try:
        ...
        logging.getLogger("vellum.cli").debug("Sem .env (%s).", exc)
...
def _fix_console_encoding() -> None:
    ...
    for stream in (sys.stdout, sys.stderr):
        ...
        try:
            ...
            logging.getLogger("vellum.cli").debug("Console sem UTF-8 (%s).", exc)
...
def run_command(
    ...
    except (ValueError, VellumError) as exc:
...
def doctor_command() -> None:
    ...
    models_dir = Path(os.environ.get("VELLUM_MODELS_DIR", "./models")).resolve()
    ...
    try:
        ...
        table.add_row(
            "Interface (Gradio)",
            '[yellow]ausente[/yellow] — pip install "vellum[ui]"',
        )
...
def disco_command(
    ...
    if modelos:
        ...
        console.print(
            "[dim]Para liberar espaço: vellum disco --remover <modelo>. "
    ...
    if pontos:
        console.print(
            ...
            "Limpe com: vellum checkpoints --limpar[/dim]"
        )
...
def ui_command(
    ...
    try:
        ...
        console.print(
            ...
            f"Instale o Gradio com: pip install \"vellum[ui]\"  ({exc})"
        )
