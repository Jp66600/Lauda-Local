...
#: Prefixo usado quando o programa se chamava MediaIntel Local. Continua sendo
#: lido para não invalidar o `.env` de quem já tinha um.
LEGACY_ENV_PREFIX = "MEDIAINTEL_"


def _env(name: str, default: str) -> str:
    valor = os.environ.get(ENV_PREFIX + name)
    if valor is None:
        valor = os.environ.get(LEGACY_ENV_PREFIX + name)
