...
log = logging.getLogger("vellum.runner")
...
class RecoveryFailed(VellumError):
...
def run_with_recovery(
    ...
    *,
    ...
    with tempfile.TemporaryDirectory(prefix="vellum_run_") as workdir:
        work = Path(workdir)
