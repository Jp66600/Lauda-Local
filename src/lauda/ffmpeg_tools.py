...
log = logging.getLogger("lauda.ffmpeg")
...
_INSTALL_HINT = (
    ...
    "Ou aponte os caminhos em .env (LAUDA_FFMPEG / LAUDA_FFPROBE)."
)
...
def resolve_tools() -> FFmpegTools:
    ...
    ffmpeg = _locate("ffmpeg", "LAUDA_FFMPEG")
    ffprobe = _locate("ffprobe", "LAUDA_FFPROBE")
